    ...
    <footer className="mt-auto border-t border-border/40 bg-card/30 backdrop-blur-sm">
      <div className="mx-auto flex w-full max-w-7xl flex-col items-center justify-between gap-6 px-4 py-8 text-xs font-medium text-muted-foreground sm:flex-row sm:px-6 sm:py-10">
        ...
        <nav className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 sm:gap-8">
          <Link
            href="/new"
            className="tracking-tight transition-colors hover:text-primary"
          >
            Create Note
          </Link>
          <Link
          ...
          <Link
            href="/donate"
            className="inline-flex items-center gap-1.5 tracking-tight transition-colors hover:text-primary"
          >
